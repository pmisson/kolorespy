...
if 0:
    ...
    cat = ['R', 'G', 'B']
    char = ['*', '.', 'o']
def scatter2(cat,char,mm):
    for ct, ch in zip(cat, char):
       tab = mm.get_group(ct)
       plt.scatter(tab['x'], tab['y'], marker=ch,color=ct)
...
def calculamagnitudes(filename,clouds):
    ...
    if 0:
        ...
        plt.show()
    return Uj_Vj,Bj_Vj,Bj_VjA,Rj_Vj,SQM_Vj,SQM_VjA,m_Bn,m_Gn,m_Rn,i_sli,i_msi,i_ipi,Bn_Vj,Gn_Vj,Rn_Vj,m_VIIRS,m_photo,m_scoto,m_photoA,m_scotoA,m_SQM,m_SQMA,m_Halpha,m_Hbeta,m_Vj,m_VjA,wave
...
lista=os.listdir(path)
lista2=" ".join(lista)
lista4=re.findall(r'[a-zA-Z_0-9+.]+\.doy.dor.dt',lista2)
lista4.sort()
listafiles2=lista4
...
for X in range(len(spec)):
    ...
    elif BG[X]>0.05 and GR[X]<0.45 and BG[X]<0.25:
        color1.append('k')
    ...
    elif BG[X]<0.25 and GR[X]>0.45 and GR[X]<0.55:
        color1.append('y')
...
wave_t=np.array([np.median(wave_r),np.median(wave_y),np.median(wave_g),np.median(wave_b),np.median(wave_w)])#,np.mean(wave_m)])
...
#plt.scatter(BG,GR,s=30, c=color1,marker=markers1, alpha=0.9)
...
plt.xlim(0,1.1)
plt.ylim(0,1.1)
rect = mpatches.Rectangle([0., 0.56], 0.34, 5, ec="none")
patches.append(rect)
rect = mpatches.Rectangle([0.34, 0.56], 5, 5, ec="none")
patches.append(rect)
rect = mpatches.Rectangle([0, 0.45], 0.25,0.1 , ec="none")
patches.append(rect)
rect = mpatches.Rectangle([0.00, 0.], 0.05,0.45 , ec="none")
patches.append(rect)
rect = mpatches.Rectangle([0.05, 0.00], 0.20,0.45 , ec="none")
patches.append(rect)
rect = mpatches.Rectangle([0.25, 0.00], 0.26,0.56 , ec="none")
patches.append(rect)
rect = mpatches.Rectangle([0.46, 0.00], 5,0.56 , ec="none")
patches.append(rect)
...
#xp = np.linspace(0, 2, 100)
#plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
ax1.scatter(spec.Bj_Vj,SQM_Vj,s=30, c=color1, alpha=0.9)
ax1.errorbar(B_V_t, SQM_Vj_t,ecolor='k',capthick=2, yerr=[SQM_Vj_tmin, SQM_Vj_tmax], xerr=[B_V_tmin, B_V_tmax], fmt='.')
ax1.scatter(B_V_t, SQM_Vj_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
#xp = np.linspace(0, 2, 100)
#plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
plt.scatter(spec.Bj_VjA,SQM_VjA,s=30, c=color1, alpha=0.9)
plt.errorbar(B_VA_t, SQM_VjA_t,ecolor='k',capthick=2, yerr=[SQM_VjA_tmin, SQM_VjA_tmax], xerr=[B_VA_tmin, B_VA_tmax], fmt='.')
plt.scatter(B_VA_t, SQM_VjA_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
#xp = np.linspace(0, 2, 100)
#plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
plt.scatter(spec.Bj_Vj,SQMVl,s=30, c=color1, alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
#xp = np.linspace(0, 2, 100)
#plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
plt.scatter(spec.Bj_Vj,SQMSC,s=30, c=color1, alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
#plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
fig, ax1 = plt.subplots()
ax1.scatter(spec.Bj_Vj,SQM_Vl,s=30, c=color1, alpha=0.9)
ax1.errorbar(B_V_t, SQM_Vl_t,ecolor='k',capthick=2, yerr=[SQM_Vl_tmin, SQM_Vl_tmax], xerr=[B_V_tmin, B_V_tmax], fmt='.')
ax1.scatter(B_V_t, SQM_Vl_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
ax2 = ax1.twinx()
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
...
plt.scatter(spec.Bj_VjA,SQM_VlA,s=30, c=color1, alpha=0.9)
plt.errorbar(B_VA_t, SQM_VlA_t,ecolor='k',capthick=2, yerr=[SQM_VlA_tmin, SQM_VlA_tmax], xerr=[B_VA_tmin, B_VA_tmax], fmt='.')
plt.scatter(B_VA_t, SQM_VlA_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
if 0:
    ...
    xp = np.linspace(0, 2, 100)
    #plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
plt.scatter(spec.Bj_Vj,SQM_SC,s=30, c=color1, alpha=0.9)
plt.errorbar(B_V_t, SQM_SC_t,ecolor='k',capthick=2, yerr=[SQM_SC_tmin, SQM_SC_tmax], xerr=[B_V_tmin, B_V_tmax], fmt='.')
plt.scatter(B_V_t, SQM_SC_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
if 0:
    ...
    xp = np.linspace(0, 2, 100)
    #plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
plt.scatter(spec.Bj_VjA,SQM_SCA,s=30, c=color1, alpha=0.9)
plt.errorbar(B_VA_t, SQM_SCA_t,ecolor='k',capthick=2, yerr=[SQM_SCA_tmin, SQM_SCA_tmax], xerr=[B_VA_tmin, B_VA_tmax], fmt='.')
plt.scatter(B_VA_t, SQM_SCA_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
if 0:
    ...
    xp = np.linspace(0, 2, 100)
    #plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
plt.scatter(spec.Bj_Vj,SQM_SQMA,s=30, c=color1, alpha=0.9)
plt.errorbar(B_V_t, SQM_SQMA_t,ecolor='k',capthick=2, yerr=[SQM_SQMA_tmin, SQM_SQMA_tmax], xerr=[B_V_tmin, B_V_tmax], fmt='.')
plt.scatter(B_V_t, SQM_SQMA_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
...
if 0:
    ...
    xp = np.linspace(0, 2, 100)
    #plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
ax1.scatter(spec.wave,SQM_SQMA,s=30, c=color1, alpha=0.9)
#plt.errorbar(wave_t, SQM_SQMA_t,ecolor='k',capthick=2, yerr=[SQM_SQMA_tmin, SQM_SQMA_tmax], xerr=[wave_tmin, wave_tmax], fmt='.')
ax1.scatter(wave_t, SQM_SQMA_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles)):
   try:
    ...
    print "fallo"
ax1.set_xlabel("Average wavelenght")
...
ax2.plot(specamply.col1,specamply.col2)
#plt.xlim(0,0.9)
#plt.ylim(0,2.1)
...
#xp = np.linspace(0, 2, 100)
#plt.plot(line_X, line_y_ransac, '-b', label='RANSAC regressor')
ax1.scatter(spec2.Bj_Vj,SQM_Vj2,s=30, c=color1, alpha=0.9)
#ax1.errorbar(B_V_t, SQM_Vj_t,ecolor='k',capthick=2, yerr=[SQM_Vj_tmin, SQM_Vj_tmax], xerr=[B_V_tmin, B_V_tmax], fmt='.')
#ax1.scatter(B_V_t, SQM_Vj_t,s=500, c=['r','y','g','b','w','m'], alpha=0.9)
#plt.plot(xp, p(xp),'r-')
if 0:
 for X in range(len(listafiles2)):
   try:
    ax1.text(spec2.Bj_Vj2[X],SQM_Vj2[X]+0.01,str(spec2[X].num),ha='right', va='bottom')
   except:
    print "fallo2"
ax1.set_xlabel("Bj - Vj")
ax1.set_ylabel("SQM - Vj")
